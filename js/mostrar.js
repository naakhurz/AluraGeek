...
function crearCard(id, url_imagen, nombre,descripcion, precio, categoria) {
    ...
    nuevaCard.innerHTML = `
        <figure class="card" alt="${categoria}">
            ...
            <figcaption class="card-container--info">
                ...
                <p class="listarSide__table">${descripcion}</p>
...
export async function mostrarProductos() {
    try {
        ...
        listaAPI.forEach(producto => {
            listaProductosContainer.appendChild(crearCard(producto.id, producto.url_imagen, producto.nombre,producto.descripcion, producto.precio, producto.categoria));
        });
    } catch (error) {
